...
void inputgen(int nops) {
  const char *keys[] = {
      "hello",       "ciao",       "algoritmi",  "strutture",  "dati",
      "hash",        "table",      "a",          "abcdabcd",   "bcdabcda",
      "oaic",        "algoritmi1", "1algoritmi", "algo1ritmi", "Al-Kwarismi",
      "al-kwarismi", "1234567890", "0987654321", "1023456789", "1230987654",
      "123",         "321",        "132",        "312",        "213",
      "231",         "567"};
